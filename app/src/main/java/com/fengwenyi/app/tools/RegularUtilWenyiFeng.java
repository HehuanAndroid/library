...
public class RegularUtilWenyiFeng {
    ...
    // 正则表达式：验证密码
    public static String REGEX_PASSWORD = "^[a-zA-Z0-9]{6,20}$";
    ...
    // 正则表达式：验证身份证
    public static String REGEX_ID_CARD = "(^\\d{18}$)|(^\\d{15}$)";

    // 正则表达式：验证URL
    public static String REGEX_URL = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w- ./?%&=]*)?";

    // 正则表达式：验证IP地址
    public static String REGEX_IP_ADDR = "(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)";
